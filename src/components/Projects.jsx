...
import React from 'react';
import { FaServer, FaUtensils, FaFutbol } from 'react-icons/fa';

const projectsData = [
  {
    icon: <FaServer className="text-[#02b8f0] text-2xl" />,
    tag: "FULL-STACK",
    title: "CampusFix",
    subtitle: "Campus Electrical Issue Management System",
    description:
...
const Projects = ({ visible }) => (
  <div
    id="projects"
    className={`py-16 bg-[#0d0d16] text-white px-6 transition-opacity duration-1000 ${
  ...
  >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
      {projectsData.map((project, index) => (
        <div
          key={index}
          className="bg-[#19142b] p-6 rounded-2xl shadow-lg border border-[#2f1860]
                      hover:scale-[1.03] 
        ...
        >
          <div>
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-white text-xs px-3 py-1 rounded-full 
                              hover:bg-gradient-to-r from-blue-400 to-yellow-400 hover:text-black 
                              transition-all duration-300 border border-[#2f1860]">
                {project.tag}
              </span>
            </div>
            ...
            <a
              ...
              className="text-purple-400 hover:underline font-medium block mb-3"
            >
              {project.subtitle}
            </a>
            ...
            <div className="flex flex-wrap gap-2 mb-5">
              {project.techs.map((tech, i) => (
                <span
                  key={i}
                  className="bg-[#2f1860] px-3 py-1 rounded-full text-sm 
                             hover:bg-gradient-to-r from-blue-400 to-yellow-400 hover:text-black 
          ...
          <div className="flex justify-between mt-auto">
            <a
              ...
              className="flex-1 bg-black text-white py-2 rounded-lg flex items-center justify-center text-sm 
                         hover:bg-gradient-to-r from-blue-400 to-yellow-400 hover:text-black transition-all duration-300"
            >
              View Code
            </a>
            <a
              href={project.liveLink}
              className="flex-1 ml-4 py-2 rounded-lg flex items-center justify-center border border-[#2f1860] text-sm 
                         text-white hover:bg-gradient-to-r from-blue-400 to-yellow-400 hover:text-black 
                         transition-all duration-300"
            >
              Live Demo
            </a>
